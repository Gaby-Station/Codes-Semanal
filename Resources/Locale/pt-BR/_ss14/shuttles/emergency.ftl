...
emergency-shuttle-command-dock-desc = Chama a nave de emergência e doca ela à sítio... se possível.

## Launch emergency shuttle
emergency-shuttle-command-launch-desc = Lança a nave de emergência antes, se possível.

# Emergency shuttle
emergency-shuttle-left = A nave de emergência saiu da sítio. Estima-se {$transitTime} segundos até que a nave chegue à Conselho O4.
emergency-shuttle-launch-time = A nave de emergência vai partir em {$consoleAccumulator} segundos.
emergency-shuttle-docked = A nave de emergência docou na sítio no lado {$direction}. Ela vai sair em {$time} segundos.
emergency-shuttle-good-luck = A nave de emergência não conseguiu achar uma sítio. Boa sorte.
emergency-shuttle-nearby = A nave de emergência não conseguiu achar um local de docagem válido. Ela parou no lado {$direction} da sítio.
