job-greet-station-name = Bem vindo ao sítio {$stationName}.
...
job-greet-crew-shortages = Como esta sítiooi inicialmente composta por uma equipe mínima, acesso adicional foi adicionado ao seu cartão ID.
