...
job-name-hos = comandante de segurança
...
job-name-engineer = engenheiro da sítio
job-name-atmostech = técnico atmosférico
job-name-hop = Gerente do sítio
job-name-captain = Diretor do sítio
job-name-serviceworker = diarista
job-name-centcomoff = membro do conselho O4
...
JobCaptain = diretor do sítio
JobCargoTechnician = técnico de logística
JobCentralCommandOfficial = membro do conselho O4
JobChaplain = padre
...
JobHeadOfPersonnel = gerente do sítio
JobHeadOfSecurity = diretor de segurança
JobJanitor = zelador
JobLawyer = advogado
