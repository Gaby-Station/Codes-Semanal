...
alert-level-gamma-announcement = A  Conselho O4 ordenou o nível de segurança Gamma na estação. Os seguranças devem estar armados a todo tempo, e todos os tripulantes devem procurar um chefe de departamento para serem transportados para um local seguro.
...
alert-level-epsilon-announcement = A  Conselho O4 ordenou o nível de segurança Epsilon na estação. Considerem todos os contratos expirados.
