alert-level-announcement = Atenção! O nível de alerta da sítiooi mudado para: {$name}! {$announcement}
...
alert-level-blue-announcement = Foram relatadas ameaças na sítioCaso seja parado por um segurança, coopere! Se ver algo suspeito avise imediatamente a segurança.
alert-level-blue-instructions = Se ver algo suspeito avise imediatamente a segurança.

alert-level-red = Vermelho
alert-level-red-announcement = Ameaça perigosa na sítioOs seguranças devem se equipar e utilizar força letal caso necessário, e os demais tripulantes procurarem um local seguro e sigam ordens das autoridades.
...
alert-level-violet-announcement = Foram relatadas ameaças virais na sítioAcionando a equipe médica para isolar os tripulantes com quaisquer sintomas. Os tripulantes são aconselhados a cumprir distanciamento e tomarem medidas de segurança para evitar uma maior propagação, usem máscaras e luvas.
...
alert-level-yellow-announcement = Há dano estrutural na sítioAcionando a equipe de engenheiros para consertar e isolar a área de danos. Os tripulantes devem evitar áreas de perigo estrutural, caso possível continuem com suas atividades.
...
alert-level-gamma-announcement = A  Conselho O4 ordenou o nível de segurança Gamma na sítioOs seguranças devem estar armados a todo tempo, e todos os tripulantes devem procurar um chefe de departamento para serem transportados para um local seguro.
...
alert-level-epsilon-announcement = A  Conselho O4 ordenou o nível de segurança Epsilon na sítioConsiderem todos os contratos expirados.
