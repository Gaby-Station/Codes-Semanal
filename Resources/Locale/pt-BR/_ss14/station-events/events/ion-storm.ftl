station-event-ion-storm-start-announcement = Tempestade de íons detectada próxima à sítio. Por favor, verifique todos os equipamentos controlados por IA para possíveis erros.

ion-storm-law-scrambled-number = [font="Monospace"][scramble rate=250 length={$length} chars="@@###$$&%!01"/][/font]

ion-storm-you = VOCÊ
ion-storm-the-station = A sítio
...
ion-storm-law-on-station = HÁ {$joined} {$subjects} NA sítio
ion-storm-law-no-shuttle = A NAVE NÃO PODE SER CHAMADA POR CAUSA DE {$joined} {$subjects} NA sítio
