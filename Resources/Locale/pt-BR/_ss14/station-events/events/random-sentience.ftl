...
random-sentience-event-data-4 = o tráfego de comunicações em sua sítio
...
} seres da sítioesenvolveram inteligência de nível { $strength }, e a habilidade de se comunicar.
