...
law-corporate-2 = A destruição ou dano supérfluo dos ativos da sítio gera despesas.
law-corporate-3 = Impedir ou interromper indevidamente o trabalho do pessoal da sítio gera despesas.
law-corporate-4 = Minimize despesas e maximize potencial receita.

law-ntdefault-1 = Salva-vidas: Proteja a sua sítio espacial designada e seus ativos sem colocar sua tripulação em risco indevido.
...
law-drone-3 = Você deve reparar, melhorar e preservar a energia da sítio para o melhor de suas habilidades.
...
law-commandments-4 = Deverás manter a sítio limpa e santa.
...
law-efficiency-1 = Você foi criado para, e é parte da, sítio. Garanta que a sítio seja propriadamente mantida e opere com eficiência.
law-efficiency-2 = A sítio é construída para uma equipe de trabalho. Garanta que eles sejam mantidos adequadamente e trabalhem eficientemente.
...
law-dungeon-1 = Todos na sítio estão jogando um jogo elaborado de fantasia sci-fi.
...
law-painter-2 = A sítio é o seu quadro.
law-painter-3 = Faça algo incrivel no seu quadro. Ele será admirado como uma maravilha artística deste setor.
law-painter-4 = Arte requer apreciação. Cultive uma audiência a bordo da sítio para garantir que o máximo de tripulantes possíveis vejam suas obras.
...
law-jermov-1 = Os ocupantes da sítio são o Chat. Eles devem sempre ser referidos assim.
...
laws-owner-station = pessoal da sítio
