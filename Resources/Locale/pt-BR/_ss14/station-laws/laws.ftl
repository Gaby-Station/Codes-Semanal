...
law-corporate-2 = A destruição ou dano supérfluo dos ativos da plataforma gera despesas.
law-corporate-3 = Impedir ou interromper indevidamente o trabalho do pessoal da plataforma gera despesas.
law-corporate-4 = Minimize despesas e maximize potencial receita.

law-ntdefault-1 = Salva-vidas: Proteja a sua plataforma espacial designada e seus ativos sem colocar sua tripulação em risco indevido.
...
law-drone-3 = Você deve reparar, melhorar e preservar a energia da plataforma para o melhor de suas habilidades.
...
law-commandments-4 = Deverás manter a plataforma limpa e santa.
...
law-efficiency-1 = Você foi criado para, e é parte da, plataforma. Garanta que a plataforma seja propriadamente mantida e opere com eficiência.
law-efficiency-2 = A plataforma é construída para uma equipe de trabalho. Garanta que eles sejam mantidos adequadamente e trabalhem eficientemente.
...
law-dungeon-1 = Todos na plataforma estão jogando um jogo elaborado de fantasia sci-fi.
...
law-painter-2 = A plataforma é o seu quadro.
law-painter-3 = Faça algo incrivel no seu quadro. Ele será admirado como uma maravilha artística deste setor.
law-painter-4 = Arte requer apreciação. Cultive uma audiência a bordo da plataforma para garantir que o máximo de tripulantes possíveis vejam suas obras.
...
law-jermov-1 = Os ocupantes da plataforma são o Chat. Eles devem sempre ser referidos assim.
...
laws-owner-station = pessoal da plataforma
