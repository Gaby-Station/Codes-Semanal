...
traitor-death-match-station-is-too-unsafe-announcement = A plataformarma está insegura demais para continuar. Você tem um minuto.
...
traitor-role-uplink-code =
    ...
    Lembre-se de bloqueá-lo depois, ou a tripulação da plataformarma poderá abri-lo facilmente!
