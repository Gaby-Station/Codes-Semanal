...
nukeops-description = agentes nucleares estão atacando a plataforma. Tente impedir que façam o big kaboom na plataforma protegendo o disco nuclear!
...
nukeops-cond-nukeexplodedoncorrectstation = Os agentes nucleares conseguiram explodir a plataforma.
nukeops-cond-nukeexplodedonnukieoutpost = O posto avançado dos agentes nucleares foi destruído por uma explosão nuclear.
nukeops-cond-nukeexplodedonincorrectlocation = A bomba nuclear foi detonada fora da plataforma.
nukeops-cond-nukeactiveinstation = A bomba nuclear foi deixada armada na plataforma.
nukeops-cond-nukeactiveatcentcom = A bomba nuclear foi entregue à  SolGov!
