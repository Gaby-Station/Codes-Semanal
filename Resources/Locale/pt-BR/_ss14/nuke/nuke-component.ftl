...
nuke-component-announcement-armed = Atenção! O mecanismo de auto-destruição da plataforma foi ativado. {$time} segundos até a detonação.
nuke-component-announcement-unarmed = A auto-destruição da plataforma foi desativada! Tenham um bom dia!
