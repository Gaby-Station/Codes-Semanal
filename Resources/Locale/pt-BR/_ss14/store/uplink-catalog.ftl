...
uplink-emag-desc = O cartão de visita do Sindicato, este sequenciador é capaz de quebrar as portas e adulterar uma variedade de dispositivos de sítio. Recarga automaticamente.
...
uplink-zombie-bundle-desc = Um kit all-in-one para soltar os mortos-vivos em cima de uma sítio.
...
uplink-syndicate-jaws-of-life-desc = Uma ferramenta combinada de forçar e corte. É útil para entrar na sítio ou em seus departamentos.
...
uplink-chameleon-desc = Uma mochila cheia de itens que contêm tecnologia camaleão, permitindo que você se disfarce de praticamente qualquer coisa na sítio, e muito mais!
