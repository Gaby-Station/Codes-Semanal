...
ent-SignAi = placa de IA
    .desc = Uma placa que indica a inteligência artificial da plataforma.
...
ent-SignSomethingOld2 = placa velha
    .desc = Contém uma imagem de um planeta colidindo contra a plataforma. Um pouco preucupante.
