ent-ComputerAlert = computador de alertas
    .desc = Usado para acessar o sistema automatizado de alertas da plataforma.
...
ent-ComputerPowerMonitoring = computador de monitoramento de energia
    .desc = Usado para monitorar a condição da rede de distribuição de energia da plataforma.
...
ent-ComputerStationRecords = computador de registros da plataforma
    .desc = Utilizado para consultar o registros da plataforma.
