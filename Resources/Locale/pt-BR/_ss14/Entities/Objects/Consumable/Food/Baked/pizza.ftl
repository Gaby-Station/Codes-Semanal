...
ent-FoodPizzaVegetable = pizza vegetariana
    .desc = Os vegetarianos da sítioão te agradecer por fazer esta pizza.

ent-FoodPizzaVegetableSlice = fatia de pizza vegetariana
    .desc = Apenas uma fatia desta pizza já é capaz de satisfazer até o pessoal mais exigente da sítio
