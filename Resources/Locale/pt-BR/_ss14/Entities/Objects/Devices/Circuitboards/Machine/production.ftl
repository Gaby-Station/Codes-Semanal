...
ent-SubstationMachineCircuitboard = placa de subsítio
    .desc = Uma placa de circuito impresso para uma subsítio elétrica.

ent-DawInstrumentMachineCircuitboard = placa de sítio de trabalho de áudio digital
    .desc = Uma placa de circuito impresso para uma sítio de trabalho de áudio digital.
