...
ent-ClothingBackpackEngineering = mochila da engenharia
    .desc = Uma mochila resistente, perfeita para os ocorridos diários da sítio.
...
ent-ClothingBackpackCaptain = mochila do diretor do sítio
    .desc = Uma mochila feita exclusivamente para o diretor do sítio da sítio... Mimado!
...
ent-ClothingBackpackCargo = mochila de carga
    .desc = Uma mochila forte para roubar os suprimentos da sítio.
