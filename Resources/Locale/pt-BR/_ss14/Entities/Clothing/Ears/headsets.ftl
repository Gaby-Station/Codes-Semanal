...
ent-ClothingHeadsetCentCom = fone de ouvido da SolGov
...
ent-ClothingHeadsetEngineering = fone de ouvido da engenharia
    .desc = Um fone de ouvido conectado ao canal dos Engenheiros. Perfeito para discussões de biscoito ou bolacha enquanto a plataforma pega fogo.
...
ent-ClothingHeadsetSecurity = fone de ouvido da segurança
    .desc = Utilizado pelos responsáveis em manter a ordem na plataforma (ou não).

ent-ClothingHeadsetService = fone de ouvido de serviço
    .desc = Um fone de ouvido utilizado pelo pessoal do Departamento de Serviços, aqueles que mantém a plataforma limpa e organizada.
